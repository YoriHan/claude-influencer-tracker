---
name: kol-add
description: "Paste Twitter/X or YouTube links/@handles, auto-scrape full KOL data, and write to Notion. First run auto-creates the Twitter/YouTube Notion databases and views. Trigger when: 'kol-add', '加 KOL', '入库 KOL', '把这些达人加进 Notion', or pasting X/YouTube creator links to start tracking them."
---
