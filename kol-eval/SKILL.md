---
name: kol-eval
description: "Deep KOL evaluation: read KOLs from Notion, scrape engagement data, score 0-100 on CPM efficiency / engagement quality / authenticity / pricing, output a verdict (合作/小单测试/压价/不合作) and write it back to Notion. Needs the separate kol-eval Python tool. Trigger when: 'kol-eval', '评估 KOL', 'KOL 价值评估', '该不该合作'."
---
